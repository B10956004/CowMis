      ...
      <div class="row">
        ...
        <div class="col-4">
          ...
          <select class="form-select" name="selectDisease" id="selectDisease" onchange="eventsChange(this)" required>
            ...
            <option value="無"<?php if($disease=='無'){echo"hidden";}?>>無</option>
            <option value="乳房炎"<?php if($disease=='乳房炎'){echo"hidden";}?>>乳房炎</option>
            <option value="蹄病"<?php if($disease=='蹄病'){echo"hidden";}?>>蹄病</option>
        ...
        <div class="col-4">
          ...
          <select class="form-select" name="selectDrug" id="selectDrug" onchange="eventsChange(this)" required>
            ...
            <option value="無"<?php if($drugs=='無'){echo"hidden";}?>>無</option>
            <option value="乳房炎藥"<?php if($drugs=='乳房炎藥'){echo"hidden";}?>>乳房炎藥</option>
            <option value="蹄病藥"<?php if($drugs=='蹄病藥'){echo"hidden";}?>>蹄病藥</option>
        ...
        <div class="col-4">
          ...
          <select class="form-select" name="selectVaccine" id="selectVaccine" onchange="eventsChange(this)" required>
            ...
            <option value="無"<?php if($vaccines=='無'){echo"hidden";}?>>無</option>
            <option value="乳房炎疫苗"<?php if($vaccines=='乳房炎疫苗'){echo"hidden";}?>>乳房炎疫苗</option>
            <option value="蹄病藥疫苗"<?php if($vaccines=='蹄病藥疫苗'){echo"hidden";}?>>蹄病藥疫苗</option>
