  ...
  <div name="content" style="width:100%; height: 100vh ;   padding:1.5rem  ;   ">
    <div class="tab-content">
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a href="#matingRecord" class="nav-link active" data-toggle="tab">配種紀錄</a>
        </li>
        <li class="nav-item">
          <a href="#addmatingRecord" class="nav-link" data-toggle="tab">新增資料</a>
        </li>
      </ul>
      <div class="tab-pane active bg-white shadow-sm p-4" id="matingRecord">
        <div class="row">
          ...
          <div id="cow_table" style="text-align:center;">
            ...
            <table id="rule" class="table table-hover">
              ...
              <tbody>
                <!-- 控制每頁的欄數 -->
                <?php
                $query = "SELECT * FROM mating_record WHERE isDel= 0 ";
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $matingMethod ?></td>
                    <td><?php echo $abortion ?></td>
                    ...
                    <script>
                      $(\"#linkDel_$i\").click(function(){
                        var yesDel = confirm(\"你確定要刪除\"+'$id'+\"這筆資料嗎？，刪除後不可復原。\");
                          if (yesDel) {
                            $.post(\"./matingRecord_delete.php\",{ Del: 1,postSn:$sn },function(result){
                              location.reload();
                              });
                          }
                        });
      ...
      <!-- 切換頁 新增 -->
      <div class="tab-pane fade bg-white shadow-sm p-4" id="addmatingRecord" style="border-radius:5px;">
        <form action="matingRecord_Insert.php" method="post">
          <div class="row">
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入編號" name="id" required>
            </div>
            <div class="col-md-3 p-2">
            配種<input type="date" class="form-control " placeholder="請輸入配種日期" name="matingDate" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入次數" name="frequency" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="狀態" name="status" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="配種方式" name="matingMethod" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="是否流產" name="abortion" required>
            </div>
