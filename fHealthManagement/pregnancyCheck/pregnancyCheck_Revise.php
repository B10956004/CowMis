...
<div class="card">
  <div class="card-body">
    <form action="pregnancyCheck_Revise_action.php?GetSn=<?php echo $GetSn; ?>" method="post">
      <div class="row">
        <div class="col-10">
          <p>編號</p>
        ...
        <div class="col-2">
          <p>胎次(配種數)</p>
          <input type="text" class="form-control card-text" name="birthparity" value='<?php echo $birthparity."({$matingcount})"; ?>' readonly>
        </div>
        <div class="col-6">
          <p>發情日期</p>
