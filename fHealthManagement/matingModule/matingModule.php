  ...
  <div name="content" style="width:100%; height: 100vh ;   padding:1.5rem  ;   ">
    <div class="tab-content">
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a href="#matingModule" class="nav-link active" data-toggle="tab">繁殖模組</a>
        </li>
        <li class="nav-item">
          <a href="#addmatingModule" class="nav-link" data-toggle="tab">新增資料</a>
        </li>
      </ul>
      <div class="tab-pane active bg-white shadow-sm p-4" id="matingModule">
        <div class="row">
          ...
          <div id="cow_table" style="text-align:center;">
            ...
            <table id="rule" class="table table-hover">
              ...
              <tbody>
                ...
                $query = "SELECT * FROM mating_module WHERE isDel=0 ";
                    ...
                    <script>
                      $(\"#linkDel_$i\").click(function(){
                        var yesDel = confirm(\"你確定要刪除\"+'$id'+\"這筆資料嗎？，刪除後不可復原。\");
                          if (yesDel) {
                            $.post(\"./matingModule_Delete.php\",{ Del: 1,postSn:$sn },function(result){
                              location.reload();
                              });
                          }
                        });
      ...
      <!-- 切換頁 新增 -->
      <div class="tab-pane fade bg-white shadow-sm p-4" id="addmatingModule" style="border-radius:5px;">
        <form action="matingModule_Insert.php" method="post">
          <div class="row">
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入編號" name="id" required>
            </div>
            <div class="col-md-3 p-2">
              預定<input type="date" class="form-control " placeholder="請輸入預定分娩日" name="dueDate" required>
            </div>
            <div class="col-md-3 p-2">
              實際<input type="date" class="form-control " placeholder="請輸入實際分娩日" name="dateCompleted" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入胎次" name="birthParity" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入胎別" name="birthEvent" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入區域" name="area" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入類別" name="class" required>
            </div>
