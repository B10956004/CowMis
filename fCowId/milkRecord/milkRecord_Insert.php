...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `milk_record`(`date`, `quality`, `volume`, `milkSolidsNotFat`, `milkFatPrecentage`, `milkProtein`, `somaticCellCount`,`totalBacteria`) 
    VALUES ('$date','$quality','$volume','$milkSolidsNotFat','$milkFatPrecentage','$milkProtein','$somaticCellCount','$totalBacteria')";
