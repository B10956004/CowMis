<?php
require_once("../../SQLServer.php");//連接資料庫
?>
<!doctype html>
<html lang="zh-TW">
  ...
  <div id="content" style="width:100%; height:100% ;   padding:1.5rem  ;   ">
    <div class="tab-content">
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
          <a href="#addCows" class="nav-link" data-toggle="tab">新增資料</a>
        </li>
      </ul>
      <!-- 牛隻資料 -->
          ...
          <div id="cow_table" style="text-align:center;">
            ...
            <table id="rule" class="table table-hover">
              ...
              <tbody>
                <!-- 控制每頁的欄數 -->
                <?php
                $query = "SELECT * FROM cows_information WHERE isDel=0 "; //預留空格 ORDER BY才有用
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $calvingInterval ?></td>
                    <td><?php echo $mid ?></td>
                    <td><?php echo $fid ?></td>
                    <td><?php echo $leaveGroup ?></td>
                    <td><a href="#revise" GetSn="<?php echo $sn; ?>" class="view_data">編輯</a></td>
                    <?php
                    // ajax Post to Delete
      ...
      <div class="tab-pane fade bg-white shadow-sm p-4" id="addCows" style="border-radius:5px;">
        <form action="cowInformation_Insert.php" method="post">
          <div class="row">
            ...
            <div class="col-md-3 p-2">
              <input type="date" class="form-control " placeholder="請輸入出生日期" name="dob" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入年齡" name="age" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入母親牛編號" name="mid" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入父親牛編號" name="fid" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入出生胎次" name="birthParity" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入離開牛群" name="leaveGroup" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="胎距" name="calvingInterval" required>
            </div>
