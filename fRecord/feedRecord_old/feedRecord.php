  ...
  <div name="content" style="width:100%; height: 100vh ;   padding:1.5rem  ;   ">
    <div class="tab-content">
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a href="#feedRecord" class="nav-link active" data-toggle="tab">飼養管理紀錄</a>
        </li>
        <li class="nav-item">
          <a href="#addFeedRecord" class="nav-link" data-toggle="tab">新增資料</a>
        </li>
      </ul>
      <div class="tab-pane active bg-white shadow-sm p-4" id="feedRecord">
        <div class="row">
          ...
          <div id="cow_table" style="text-align:center;">
            ...
            <table id="rule" class="table table-hover">
              ...
              <tbody>
                <!-- 控制每頁的欄數 -->
                <?php
                $query = "SELECT * FROM feed_record WHERE isDel=0 ";
                    ...
                    <script>
                      $(\"#linkDel_$i\").click(function(){
                        var yesDel = confirm(\"你確定要刪除\"+'$id'+\"這筆資料嗎？，刪除後不可復原。\");
                          if (yesDel) {
                            $.post(\"./feedRecord_Delete.php\",{ Del: 1,postSn:$sn },function(result){
                              location.reload();
                              });
                          }
                        });
      ...
      <!-- 切換頁 新增 -->
      <div class="tab-pane fade bg-white shadow-sm p-4" id="addFeedRecord" style="border-radius:5px;">
        <form action="feedRecord_Insert.php" method="post">
          <div class="row">
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入個體識別" name="id" required>
            </div>
            <div class="col-md-3 p-2">
            進場<input type="date" class="form-control " placeholder="請輸入進場日期" name="date" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入系譜" name="genealogy" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入精料" name="concentrate" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入芻料" name="forage" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入是否懷孕" name="isPregnancy" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入是否泌乳" name="lactation" required>
            </div>
            <div class="col-md-3 p-2">
              <input type="text" class="form-control " placeholder="請輸入飲水量" name="waterIntake" required>
            </div>
            <div class="col-md-3 p-2">
            餵養<input type="datetime-local" class="form-control " placeholder="請輸入餵養時間" name="feedTime" required>
            </div>
            <div class="col-md-3 p-2">
            紀錄<input type="datetime-local" class="form-control " placeholder="請輸入紀錄時間" name="recordTime" required>
            </div>
